...
def score_model(model, test_data):
    ...
    :param test_data: dataframe with test dataset with at least the following columns:
    ...
    logging.info("OK - calculated F1 score = {:.2f}".format(f1_score))
...
if __name__ == '__main__':
    ...
    logging.info("OK - main: loaded test_data containing {} rows".format(test_data.shape[0]))
